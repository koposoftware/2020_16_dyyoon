	...
	<div class="row pt-2">
			...
			<div class="col-md-8">
				<div class="mb-4">
				  <div class="card border-left-success shadow h-100 py-2">
		             <div class="card-body">
		             	<h4 class="small font-weight-bold text-success">승인 완료 현황 <span class="float-right">${ remittanceCount["PERCENTAGE"] } %</span></h4>
			...
			<div class="card shadow mb-4">
	            ...
	            <div class="card-body">
	              <div class="table-responsive">
	                <table class="table table-bordered table-hover admin-table-select table-th-success displayDataTable" >
	                  <thead>
	                    <tr>
	                      <th>송금 일자</th>
	                      <th>보낸 분 계좌번호</th>
