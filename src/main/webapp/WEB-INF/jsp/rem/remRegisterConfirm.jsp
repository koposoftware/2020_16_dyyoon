	...
	<div class="container allAccount-con pt-3 pb-3">
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="text-center">
					<button class="btn btn-secondary" onclick="window.location.href='${ pageContext.request.contextPath }/remittance'">뒤로가기</button>
					
					<form action="${ pageContext.request.contextPath }/remittance" method="post">
					
					<input type="hidden" value="${ remittanceVO }" name="remittanceVO">
