...
<body>
								...
								<div class="input-group">
									...
									<div class="input-group-append">
										<button class="btn btn-info " type="button"
											    data-toggle="modal" data-target="#reserveForm-myData-modal">
											    상세보기
										</button>
									</div>
								</div>
								...
								<div class="input-group">
									...
									<div class="input-group-append">
										<button class="btn btn-info registerForm-infoNo-btn" type="button" disabled="disabled" data-toggle="modal"
											data-target="#reserveForm-infoNo-modal">상세보기</button>
									</div>
	...
	<!-- 보내는 분(내정보) 상세 -->
	<div class="modal" id="reserveForm-myData-modal">
		<div
	...
	<!-- 받는 분 정보 상세 -->
	<div class="modal" id="reserveForm-infoNo-modal">
		<div
			class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header bg-info">
				...
				<!-- Modal body -->
				<div class="modal-body" id="reserveForm-infoNo-modal-body"></div>
		...
		$('.registerForm-infoNo-btn').on('click',
				function() {
					...
					$.ajax({
						...
						success : function(data) {
							//console.log('통신성공~!');
							$('#reserveForm-infoNo-modal-body').html(data)
						},
						error : function() {
