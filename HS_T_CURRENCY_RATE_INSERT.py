...
for i in range(50):
    kk = array[i]
    #print(kk[0])
    sql_insert = 'insert into hs_t_currency_rate VALUES(:a, :b, :c, :d, :e, :f,:g,:h,:i,:j,:k,:l,:m)'
    cursor.execute(sql_insert, a=kk[0], b=kk[1], c=kk[2] ,d=kk[3], e=kk[4],f=kk[5],g=kk[6],h=kk[7],i=kk[8],j=kk[9],k=kk[10],l=kk[11],m=now)
